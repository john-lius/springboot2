/*
 * ! jQuery JavaScript Library v1.9.0 http://jquery.com/
 * 
 * Includes Sizzle.js http://sizzlejs.com/
 * 
 * Copyright 2005, 2012 jQuery Foundation, Inc. and other contributors Released under the MIT license
...
(function(window, undefined) {
     ...
     * 
     * options: an optional list of space-separated options that will change how the callback list behaves or a more
     ...
     * 
     * memory: will keep track of previous values and will call any callback added after the list has been fired right
    ...
    /*
     * Helper functions for managing events -- not part of the public interface. Props to Dean Edwards' addEvent library
    ...
    jQuery.event = {
            ...
            while (t--) {
                ...
                while (j--) {
                    ...
                    if ((mappedTypes || origType === handleObj.origType)
                        && (!handler || handler.guid === handleObj.guid) && (!tmp || tmp.test(handleObj.namespace))
        ...
        trigger : function(event, data, elem, onlyHandlers) {
            ...
            var i, cur, tmp, bubbleType, ontype, handle, special, eventPath = [ elem || document ], type = event.type
                || event, namespaces = event.namespace ? event.namespace.split(".") : [];
        ...
        dispatch : function(event) {
            ...
            var i, j, ret, matched, handleObj, handlerQueue = [], args = core_slice.call(arguments), handlers = (jQuery
    ...
    /*
     * ! Sizzle CSS Selector Engine Copyright 2012 jQuery Foundation and other contributors Released under the MIT
     * license http://sizzlejs.com/
     */
    (function(window, undefined) {
        ...
        Expr = Sizzle.selectors = {
            ...
            preFilter : {
                ...
                "CHILD" : function(match) {
                     ...
                     * (even|odd|\d*|\d*n([+-]\d+)?|...) 4 xn-component of xn+y argument ([+-]?\d*n|) 5 sign of
                    ...
                    return function(elem) {
                        ...
                        return operator === "=" ? result === check : operator === "!=" ? result !== check
                            : operator === "^=" ? check && result.indexOf(check) === 0 : operator === "*=" ? check
                                ...
                                && result.substr(result.length - check.length) === check : operator === "~=" ? (" "
                                + result + " ").indexOf(check) > -1 : operator === "|=" ? result === check
    ...
    function getAll(context, tag) {
        var elems, elem, i = 0, found = typeof context.getElementsByTagName !== "undefined" ? context
            .getElementsByTagName(tag || "*") : typeof context.querySelectorAll !== "undefined" ? context
    ...
    /*
     * Handles responses to an ajax request: - sets all responseXXX fields accordingly - finds the right dataType
     * (mediates between content-type and expected dataType) - returns the corresponding response
     */
